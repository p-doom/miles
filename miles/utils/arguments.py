...
def get_miles_extra_args_provider(add_custom_arguments=None):
    def add_miles_arguments(parser):
        ...
        def add_data_arguments(parser):
            ...
            parser.add_argument("--val-interval", type=int, default=None, help="Interval for validation.")
            parser.add_argument("--val-steps", type=int, default=None, help="Number of steps for validation.")
