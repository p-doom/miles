...
# =============================================================================
# Miles Build Script (CUDA 12.6 Slurm Version)
# 
# This script uses uv for Python environment management.
# It relies on the Slurm module system for CUDA 12.6 instead of pip packages.
# 
# Configuration:
# - CUDA: 12.6 (via module load)
# - PyTorch: 2.8.0 (cu126)
# - Flash Attention 3: Prebuilt for cu126 + torch2.8
...
if ! command -v nvcc &> /dev/null; then
    ...
    echo "Please ensure 'module load CUDA/12' works on this cluster."
    exit 1
fi
...
# =============================================================================
echo "Installing PyTorch 2.8.0 with CUDA 12.6..."

# Install cuda-python (Pinned to 12.6 to match the module)
uv pip install cuda-python==12.6.0

# Install PyTorch 2.8.0 for CUDA 12.6
...
# =============================================================================
# Install Flash Attention 3 (prebuilt wheels for cu126 + torch2.8)
# =============================================================================
echo "Installing Flash Attention 3..."
# Using windreamer's wheel index for CUDA 12.6 and PyTorch 2.8.0
uv pip install flash_attn_3 --find-links https://windreamer.github.io/flash-attention3-wheels/cu126_torch280 --extra-index-url https://download.pytorch.org/whl/cu126
# =============================================================================
# Install Flash Attention 2 (prebuilt wheel for Megatron compatibility)
# =============================================================================
echo "Installing Flash Attention 2..."
uv pip install https://github.com/mjun0812/flash-attention-prebuild-wheels/releases/download/v0.4.11/flash_attn-2.8.3+cu126torch2.8-cp312-cp312-linux_x86_64.whl
